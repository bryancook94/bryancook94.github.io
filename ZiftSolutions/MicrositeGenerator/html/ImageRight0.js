function ImageRight(key){

  var keyspace=key.match(/[A-Z][a-z]+/g).join(" ");
  var number=key.match(/[0-9]+/g);
			...
			<div class="z_col-xs-12 z_col-md-6" style="padding-bottom:20px;">
				...
				<div class="z_button-container">
					<span zcondition="${keyspace} Link Option!='None'" zp="true">
						...
						<a id="imageRight${number}LinkForm" class="z_button idCarrier formNotFilled" zstep="Asset Form" zasset="assetWWWWWW" zmodal="large" type="button" zsubmit="false" zp="true"><zp name="${keyspace} CTA Copy">Button</zp></a>
